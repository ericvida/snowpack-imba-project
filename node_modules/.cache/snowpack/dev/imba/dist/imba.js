...
class ImbaElementRegistry {
	...
	get(name,klass){
		...
		if (!name || name == 'component') { return _internal_component__WEBPACK_IMPORTED_MODULE_6__["ImbaElement"] }		if (this.types[name]) { return this.types[name] }		if (klass && root[klass]) { return root[klass] }		return root.customElements.get(name) || _internal_component__WEBPACK_IMPORTED_MODULE_6__["ImbaElement"];
	}
...
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
function iter$(a){ return a ? (a.toIterable ? a.toIterable() : a) : []; }function extend$(target,ext){
	// @ts-ignore
	var descriptors = Object.getOwnPropertyDescriptors(ext);
	// @ts-ignore
	Object.defineProperties(target.prototype,descriptors);
...
extend$(_dom__WEBPACK_IMPORTED_MODULE_0__["DocumentFragment"],{
	...
	isEmpty$(){
		...
		while (el = el.nextSibling){
			...
			if (el == end) { break; }			if ((el instanceof _dom__WEBPACK_IMPORTED_MODULE_0__["Element"]) || (el instanceof _dom__WEBPACK_IMPORTED_MODULE_0__["Text"])) { return false }		}		return true;
	},
});
